...
const AboutPageSkill = () => {
  ...
  if (width >= 768 && width < 1024 && orientation === "landscape") {
    ...
    return (
      <main className="w-full h-[100vh] sm:h-[100vh] grid sm:grid-rows-[20vh_80vh]">
        <div className="w-full h-full flex justify-center md:items-end lg:items-center">
          <ul className="w-[80%] lg:w-[50%] h-[50%] sm:h-[50%] md:h-[50%] bg-[#F3F4F6] grid grid-cols-3 rounded-[20px] lg:rounded-[15px] border-3 border-black">
            <SkillNavigationList
              nav="Frontend"
              skillPage={skillPage}
              handleSetPage={handleSetPage}
    ...
    return (
      <main className="w-full h-[100vh] sm:h-[200vh] md:h-[100vh] lg:h-[170vh] xl:h-[170vh] grid grid-rows-[20vh_80vh] sm:grid-rows-[30vh_130vh] md:grid-rows-[20vh_80vh] lg:grid-rows-[20vh_80vh] xl:grid-rows-[30vh_100vh]">
        <div className="w-full h-full flex justify-center md:items-end lg:items-center">
          <ul className="w-[80%] lg:w-[50%] h-[50%] sm:h-[90%] md:h-[50%] bg-[#F3F4F6] grid grid-cols-3 rounded-[20px] lg:rounded-[15px] border-3 border-black">
            <SkillNavigationList
              nav="Frontend"
