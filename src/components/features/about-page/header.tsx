...
const AboutPageHeader = () => {
  ...
  if (width < 1024) {
    return (
      <>
        <header className="sm:pt-[10vh] md:pt-0 h-[90vh] sm:h-[clamp(1050px,90vh,1200px)] md:h-[90vh] grid grid-rows-[40vh_50vh] sm:grid-rows-[clamp(450px,40vh,500px)_clamp(600px,50vh,800px)] md:grid-rows-[40vh_50vh]">
