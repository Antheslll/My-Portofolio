...
const ProjectMain = () => {
  ...
  if (width >= 768 && width < 1024 && orientation === "landscape") {
    return (
      <main
        id="project-main"
        className="sm:pt-[10vh] md:pt-0 h-[100vh] sm:h-[250vh] md:h-[270vh] grid md:grid-rows-[70vh_130vh_10vh]"
      >
    ...
    return (
      <main
        id="project-main"
        className=" h-[100vh] sm:h-[110vh] grid grid-rows-[30vh_50vh_10vh] sm:grid-rows-[40vh_50vh_10vh]"
      >
        <div className="w-full flex-centered pt-[5vh]">
          <div className="lg:w-[60%] w-[80%] flex flex-col gap-y-[2vh] lg:gap-y-[4vh]">
            <h2 className="poppins-font font-semibold text-center text-[4vw] lg:text-[3vw]">
