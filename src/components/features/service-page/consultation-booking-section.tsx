...
const ConsultationBookingSection = () => {
  return (
    <div className="w-full h-[5vh] flex-centered">
      <div className="w-[80%] h-[60px] bg-[#1F2937] flex-centered rounded-md ">
        <div className="w-full h-[40px]  rounded-[5%] grid grid-cols-[2fr_2fr_1.5fr]">
          <div className="w-full grid grid-cols-[1fr_5fr_0.5fr] border-r-1 border-white">
