...
const ContactButton = ({
  ...
  return (
    <Link href={href} target="_blank">
      <button
        className={`w-[50vw] sm:w-[30vw] md:w-[50vw] lg:w-[20vw] xl:w-[17vw] h-[clamp(50px,7vh,150px)] sm:h-[20vh] md:h-[7vh] xl:h-[clamp(40px,8vh,60px)] border-5 rounded-full grid grid-cols-[40%_60%] sm:grid-cols-[30%_70%] md:grid-cols-[40%_60%] xl:grid-cols-[30%_70%]  ${border}`}
      >
