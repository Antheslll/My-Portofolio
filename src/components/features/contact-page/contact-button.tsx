  ...
  return (
    <Link href={href} target="_blank">
      ...
      >
        ...
        <span
          className={`w-full h-full flex items-center text-[4vw] sm:text-[3vw] md:text-[4vw] lg:text-[2vw] xl:text-[clamp(20px,1.7vw,24px)] ${color}`}
        >
          {contact}
        </span>
      </button>
  ...
  return (
    <Link href={href} target="_blank">
      ...
      >
        ...
        <span
          className={`w-full h-full flex items-center  md:text-[3.5vw] ${color}`}
        >
          {contact}
        </span>
      </button>
